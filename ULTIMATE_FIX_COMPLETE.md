...
- **السبب:** استخدام comma-separated string يفسر commas كـ separators
- **الحل:** استخدام individual `--update-env-vars` flags
...
- يستخدم individual flags للـ environment variables
...
### 1. Individual Flags للـ Environment Variables
```powershell
# قبل (خطأ):
--update-env-vars "VAR1=value1,VAR2=value2,value3"

# بعد (صحيح):
--update-env-vars VAR1=value1 --update-env-vars VAR2=value2,value3
```
